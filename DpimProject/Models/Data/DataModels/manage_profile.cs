...
namespace DpimProject.Models.Data.DataModels
{
    ...
    public class manage_profile //Create 11/21/2020 3:45:50 AM
    {
        ...
        public int? is_edit_upload_front_id_document { get; set; }

        public int? is_edit_upload_front_back_document { get; set; }

        public int? is_edit_upload_selfie_document { get; set; }

        public int? is_edit_upload_business_document { get; set; }
