            ...
            try
            {
                using (DataContext db = new DataContext())
                {
                    var data = db.manage_profile.ToList().Select(x => new
                    {
                        ...
                        x.is_edit_business,
                        x.is_edit_upload_front_id_document,
                        x.is_edit_upload_front_back_document,
                        x.is_edit_upload_selfie_document,
                        x.is_edit_upload_business_document,
                ...
                using (DataContext db = new DataContext())
                {
                    if (db.manage_profile.Count() == 0)
                    {
                        manage_profile data = new manage_profile()
                        {
                            ...
                            is_edit_upload_front_id_document = profile.is_edit_upload_front_id_document,
                            is_edit_upload_front_back_document = profile.is_edit_upload_front_back_document,
                            is_edit_upload_selfie_document = profile.is_edit_upload_selfie_document,
                            is_edit_upload_business_document = profile.is_edit_upload_business_document,
                    ...
                    else
                    {
                        ...
                        data.is_edit_upload_front_id_document = profile.is_edit_upload_front_id_document;
                        data.is_edit_upload_front_back_document = profile.is_edit_upload_front_back_document;
                        data.is_edit_upload_selfie_document = profile.is_edit_upload_selfie_document;
                        data.is_edit_upload_business_document = profile.is_edit_upload_business_document;
