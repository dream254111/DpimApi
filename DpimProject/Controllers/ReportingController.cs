...
namespace DpimProject.Controllers
{
    ...
    public class ReportingController : ApiController
    {
        ...
        public dynamic report_student_by_id(int student_id)
        {
            ...
            var data = (string.IsNullOrEmpty(error)) ? reportStudent.get_student_by_id(auth.user_id, student_id, ref error) : null;
        ...
        [HttpGet]
        public dynamic EvaluationReport(string course_id, DateTime? start_date = null, DateTime? end_date = null)
        {

            string error = "";
            GetToken(ref error);

            var data = (string.IsNullOrEmpty(error)) ? reportStudent.EvaluationReport(course_id, start_date, end_date, ref error):null;
        ...
        public dynamic CertificatePrintReportByCategory(string category_id, DateTime? start_date = null, DateTime? end_date = null)
        {
            ...
            var data = (string.IsNullOrEmpty(error)) ? reportStudent.get_certificate_print_report_by_category(auth.user_id, category_id, start_date, end_date, ref error):null;
        ...
        public dynamic CoursePrint(string id)
        {
            ...
            var data = (string.IsNullOrEmpty(error)) ? reportStudent.CoursePrint(auth.user_id, id, ref error):null;
            var output = new
            {
                success = string.IsNullOrEmpty(error),
                error,
        ...
        public dynamic CourseView(string id)
        {
            ...
            var data = (string.IsNullOrEmpty(error)) ? reportStudent.CourseView(auth.user_id, id, ref error):null;
            var output = new
            {
                success = string.IsNullOrEmpty(error),
                error,
        ...
        [ActionName("report_topten")]
        [HttpPost]
        public dynamic report_topten()
        {
            string error = "";
            GetToken(ref error);
            ...
            var data = reportStudent.get_report_topten(get_body.id, get_body.category_id, get_body.start_date, get_body.end_date, ref error);
        ...
        [ActionName("student_exam_raw")]
        [HttpGet]
        public dynamic student_exam_raw(string course_id)
        {
            string error = "";
            GetToken(ref error);

            var data = (string.IsNullOrEmpty(error)) ? reportStudent.student_exam_raw(course_id, ref error) : null;
