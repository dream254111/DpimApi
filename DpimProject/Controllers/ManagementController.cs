...
namespace DpimProject.Controllers
{
    ...
    public class ManagementController : ApiController
    {
        ...
        [ActionName("SignatureCertificate")]
        [HttpPost]
        public HttpResponseMessage SignatureCertificate()
        {
            string error = "";
            GetToken(ref error);
            ...
            m = Dtl.json_to_object(Dtl.json_request(), m);
            HttpResponseMessage resp = new HttpResponseMessage(HttpStatusCode.OK);
            manage.SignatureCertificate(m, auth, ref error);
            var output = new
            {
                success = string.IsNullOrEmpty(error),
                error
        ...
        [ActionName("SignatureRead")]
        [HttpGet]
        public HttpResponseMessage SignatureReadList()
        {
            string error = "";
            GetToken(ref error);
          
            HttpResponseMessage resp = new HttpResponseMessage(HttpStatusCode.OK);
      var data=      manage.SignatureRead(ref error);
            var output = new
            {
                success = string.IsNullOrEmpty(error),
                error,
        ...
        [ActionName("DocumentTypeReadList")]
        [HttpGet]
        public HttpResponseMessage DocumentTypeReadList()
        {
            string error = "";
            GetToken(ref error);
            var data = manage.DocumentTypeReadList(ref error);
            var output = new
            {
                success = string.IsNullOrEmpty(error),
            error,
        ...
        [ActionName("DocumentTypeCreate")]
        [HttpPost]
        public HttpResponseMessage DocumentTypeCreate()
        {
            string error = "";
            GetToken(ref error);
            var m = new document_type();
            m = Dtl.json_to_object(Dtl.json_request(), m);
           manage.DocumentTypeCreate(m,auth,ref error);
            var output = new
            {
                success = string.IsNullOrEmpty(error),
                error
            ...
            resp.Content = new ObjectContent<object>(output, new JsonMediaTypeFormatter());
            return resp;
        } [ActionName("DocumentTypeUpdate")]
        [HttpPost]
        public HttpResponseMessage DocumentTypeUpdate()
        {
            string error = "";
            GetToken(ref error);
            var m = new document_type();
            m = Dtl.json_to_object(Dtl.json_request(), m);
           manage.DocumentTypeUpdate(m,auth,ref error);
            var output = new
            {
                success = string.IsNullOrEmpty(error),
                error
